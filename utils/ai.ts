 // llm sefl learning programer 
// GPT stands for generative pre-trained transformer
// LangChain 
import { OpenAI } from 'langchain/llms/openai'
import { StructuredOutputParser } from "langchain/output_parsers"
import { PromptTemplate } from "langchain/prompts"
// StructuredOutputParser well make as the z schema easier 
import z from 'zod'
...
// the z lets have lots of fun with chat gpt
const parser = StructuredOutputParser.fromZodSchema(
  ...
  sentimentScore: z.number().describe('sentiment of the text and rated on a scale from -10 to 10, where -10 is extremely negative, 0 is neutral, and 10 is extremely positive.'),
    ...
    // the use of the PERIOD ' . ' tells the Ai that's " it "
